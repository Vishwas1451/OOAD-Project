		...
		<div class="row">
			<div class="col-md-12">
					...
					<div class="base_container">
						<c:forEach items="${products }" var="p">
							<div class="event">
								...
								<h5>${p.description }</h5>
								<h2>&#x20B9; ${p.price }</h2>
								<a href="deleteEvent/${p.id}"><i class="fa-solid fa-trash text-danger" style="font-size: 25px;"></i></a>
							</div>
				...
				<div class="container text-center">
					<a href="add-product" class="btn">Add Event</a>
				</div>
